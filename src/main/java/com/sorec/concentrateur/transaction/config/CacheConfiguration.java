package com.sorec.concentrateur.transaction.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        config.getMapConfigs().put("com.sorec.concentrateur.transaction.domain.*", initializeDomainMapConfig(jHipsterProperties));
