...
/**
 * REST controller for managing {@link com.sorec.concentrateur.transaction.domain.Modeoperationenum}.
 */
@RestController
@RequestMapping("/api")
public class ModeoperationenumResource {
    ...
    private static final String ENTITY_NAME = "transactionModeoperationenum";
