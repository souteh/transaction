...
/**
 * REST controller for managing {@link com.sorec.concentrateur.transaction.domain.Formulationentity}.
 */
@RestController
@RequestMapping("/api")
public class FormulationentityResource {
    ...
    private static final String ENTITY_NAME = "transactionFormulationentity";
