...
public class ClientglentityResourceIT {
    ...
    public void createClientglentity() throws Exception {
        ...
        ClientglentityDTO clientglentityDTO = clientglentityMapper.toDto(clientglentity);
        restClientglentityMockMvc.perform(post("/api/clientglentities")
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(clientglentityDTO)))
    ...
    public void updateClientglentity() throws Exception {
        ...
        updatedClientglentity
            ...
            .telephone(UPDATED_TELEPHONE)
            .commentaire(UPDATED_COMMENTAIRE);
        ClientglentityDTO clientglentityDTO = clientglentityMapper.toDto(updatedClientglentity);
