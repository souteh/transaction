...
public class PdventityResourceIT {
    ...
    public void createPdventity() throws Exception {
        ...
        PdventityDTO pdventityDTO = pdventityMapper.toDto(pdventity);
        restPdventityMockMvc.perform(post("/api/pdventities")
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(pdventityDTO)))
    ...
    public void updatePdventity() throws Exception {
        ...
        updatedPdventity
            .idpdv(UPDATED_IDPDV)
            .referencepdv(UPDATED_REFERENCEPDV);
        PdventityDTO pdventityDTO = pdventityMapper.toDto(updatedPdventity);
