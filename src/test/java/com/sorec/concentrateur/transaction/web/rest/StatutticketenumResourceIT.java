...
public class StatutticketenumResourceIT {
    ...
    public void createStatutticketenum() throws Exception {
        ...
        StatutticketenumDTO statutticketenumDTO = statutticketenumMapper.toDto(statutticketenum);
        restStatutticketenumMockMvc.perform(post("/api/statutticketenums")
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(statutticketenumDTO)))
    ...
    public void updateStatutticketenum() throws Exception {
        ...
        updatedStatutticketenum
            ...
            .paye(UPDATED_PAYE)
            .rembourse(UPDATED_REMBOURSE);
        StatutticketenumDTO statutticketenumDTO = statutticketenumMapper.toDto(updatedStatutticketenum);
