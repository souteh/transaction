...
public class TypeterminalenumResourceIT {
    ...
    public void createTypeterminalenum() throws Exception {
        ...
        TypeterminalenumDTO typeterminalenumDTO = typeterminalenumMapper.toDto(typeterminalenum);
        restTypeterminalenumMockMvc.perform(post("/api/typeterminalenums")
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(typeterminalenumDTO)))
    ...
    public void updateTypeterminalenum() throws Exception {
        ...
        updatedTypeterminalenum
            ...
            .b2062(UPDATED_B_2062)
            .pda(UPDATED_PDA);
        TypeterminalenumDTO typeterminalenumDTO = typeterminalenumMapper.toDto(updatedTypeterminalenum);
