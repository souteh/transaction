...
public class CatonlinecanalenumResourceIT {
    ...
    public void createCatonlinecanalenum() throws Exception {
        ...
        CatonlinecanalenumDTO catonlinecanalenumDTO = catonlinecanalenumMapper.toDto(catonlinecanalenum);
        restCatonlinecanalenumMockMvc.perform(post("/api/catonlinecanalenums")
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(catonlinecanalenumDTO)))
    ...
    public void updateCatonlinecanalenum() throws Exception {
        ...
        updatedCatonlinecanalenum
            .pel(UPDATED_PEL)
            .ptel(UPDATED_PTEL);
        CatonlinecanalenumDTO catonlinecanalenumDTO = catonlinecanalenumMapper.toDto(updatedCatonlinecanalenum);
