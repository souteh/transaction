...
public class TypepaiementenumResourceIT {
    ...
    public void createTypepaiementenum() throws Exception {
        ...
        TypepaiementenumDTO typepaiementenumDTO = typepaiementenumMapper.toDto(typepaiementenum);
        restTypepaiementenumMockMvc.perform(post("/api/typepaiementenums")
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(typepaiementenumDTO)))
    ...
    public void updateTypepaiementenum() throws Exception {
        ...
        updatedTypepaiementenum
            .total(UPDATED_TOTAL)
            .avance(UPDATED_AVANCE);
        TypepaiementenumDTO typepaiementenumDTO = typepaiementenumMapper.toDto(updatedTypepaiementenum);
