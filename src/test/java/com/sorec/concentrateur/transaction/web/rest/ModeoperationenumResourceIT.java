...
import com.sorec.concentrateur.transaction.TransactionApp;
...
import com.sorec.concentrateur.transaction.service.ModeoperationenumService;
...
import com.sorec.concentrateur.transaction.service.ModeoperationenumQueryService;
...
public class ModeoperationenumResourceIT {
    ...
    public void createModeoperationenum() throws Exception {
        ...
        ModeoperationenumDTO modeoperationenumDTO = modeoperationenumMapper.toDto(modeoperationenum);
        restModeoperationenumMockMvc.perform(post("/api/modeoperationenums")
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(modeoperationenumDTO)))
    ...
    public void updateModeoperationenum() throws Exception {
        ...
        updatedModeoperationenum
            .automatique(UPDATED_AUTOMATIQUE)
            .manuel(UPDATED_MANUEL);
        ModeoperationenumDTO modeoperationenumDTO = modeoperationenumMapper.toDto(updatedModeoperationenum);
