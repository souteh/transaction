...
import com.sorec.concentrateur.transaction.service.FormulationentityService;
...
import com.sorec.concentrateur.transaction.service.FormulationentityQueryService;
...
public class FormulationentityResourceIT {
    ...
    public void createFormulationentity() throws Exception {
        ...
        FormulationentityDTO formulationentityDTO = formulationentityMapper.toDto(formulationentity);
        restFormulationentityMockMvc.perform(post("/api/formulationentities")
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(formulationentityDTO)))
    ...
    public void updateFormulationentity() throws Exception {
        ...
        updatedFormulationentity
            ...
            .misetotale(UPDATED_MISETOTALE)
            .numform(UPDATED_NUMFORM);
        FormulationentityDTO formulationentityDTO = formulationentityMapper.toDto(updatedFormulationentity);
